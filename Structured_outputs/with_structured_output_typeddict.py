...
class Review(TypedDict):
    ...
    pros: Annotated[Optional[list[str]], "A list of pros mentioned in the review in a list"]
    cons: Annotated[Optional[list[str]], "A list of cons mentioned in the review in a list"]
    name: Annotated[str, "The name of the product being reviewed"]


structured_output = model.with_structured_output(schema=Review)
