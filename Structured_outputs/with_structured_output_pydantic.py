...
class Review(BaseModel):
    ...
    sentiment: Literal["pos", "neg"] = Field(description="The sentiment of the review, Either 'positive', 'negative'")
    pros: Optional[list[str]] = Field(None, description="A list of pros mentioned in the review in a list")
    cons: Optional[list[str]] = Field(None, description="A list of cons mentioned in the review in a list")
    name: Optional[str] = Field(None, description="The name of the product being reviewed")
